                ...
                <v-card>
                    <v-card-text>
                        ...
                        <v-col cols="12" md = "6" lg="6">
                            <v-text-field
                                label="National ID"
                                v-model="newStudent.national_id"
                            ></v-text-field>
                        </v-col>
                        <v-col cols="12" md = "6" lg="6">
                            <v-text-field
                                label="Number Plate"
                                v-model="newStudent.number_plate"
                            ></v-text-field>
                        </v-col>
                        </v-row>
                        </v-container>
    ...
    export default {
        ...
        methods: {
            sendRecord: async function() {
                ...
                let res = await fetch(`http://km.dev.localhost:5000/signup/${this.newStudent.phoneNumber}/${this.newStudent.password}/${this.newStudent.name}/${this.newStudent.number_plate}/${this.newStudent.national_id}`);
                    if(!res.ok){
                ...
                if(res.ok) { 
                    ...
                    this.$router.push({path: '/everything'});
